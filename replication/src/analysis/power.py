...
Answers the referee's call for a full power analysis: how often does the
e-process reject H0: alpha = 0 when a true alpha is present, and how well
is Type-I error controlled when it is not?

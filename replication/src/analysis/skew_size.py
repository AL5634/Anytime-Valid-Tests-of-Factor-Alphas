...
skewed and heavy-tailed residual DGPs (response to referee Major Comment 2).
...
anomaly residuals are skew and heavy-tailed (IA Table A9: median skew -0.18,
median excess kurtosis 4.77 among rejectors, with far more extreme values in
the tails), we ask empirically whether the empirical size stays at or below
the nominal 5% under such shapes.

...
Core implementation of the paper's test. Constructs an anytime-valid
e-process for the regression intercept (alpha) of a factor return
series, valid under arbitrary optional stopping and continuation.
